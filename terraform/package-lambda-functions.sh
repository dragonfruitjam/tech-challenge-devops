# this script packages the lambda funtions with the required packages so that they can be deployed to aws by terraform 
...
# removes unneccessary files from lambda function folder
rm ../temp/dockerfile
